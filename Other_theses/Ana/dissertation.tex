...
\university{Department of Computer Architecture and Technology}
\degree{by: \\}
\author{Ana Dom\'{i}nguez Fanlo}
\collegeordept{}
\textadvisor{Supervised by:\\ }
\advisor{Dr. Alberto Lafuente Rojo}
\advisortwo{\& \\ Dr. Mikel Zorrilla Berasategi}
\textsignaturecandidate{}
\textsignatureadvisor{}
\cityofbirth{Donostia -- San Sebastian}
%\degreedate{\monthname \ \the\year}
\degreedate{Thursday 13th February, 2020}
...
\newcolumntype{Q}{>{\centering\arraybackslash}m{1.7cm}}
\newcolumntype{N}{>{\centering\arraybackslash}m{3.5cm}}
\newcolumntype{O}{>{\centering\arraybackslash}m{3.5cm}}
